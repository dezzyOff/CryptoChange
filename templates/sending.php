...
<div class="order__data-header">
    <h2 class="order__data-title"><?php echo $translationService->trans('sending_funds_in_progress'); ?></h2>
...
<div class="order__details">
    <div class="order__details-status-content">
        ...
        <span class="details__status-label">
            <?php echo $translationService->trans('sending_your_funds'); ?>
        </span>
        <span class="details__status-description">
            <?php echo $translationService->trans('please_wait_transaction'); ?>
        </span>
    </div>
